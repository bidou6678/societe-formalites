...
export default function Header() {
  return (
    <header className="bg-white h-[76px] flex items-center shrink-0 w-full">
      <div className="w-full max-w-[1440px] mx-auto px-10 flex items-center gap-8 h-full">
        {/* Logo */}
        <Link href="/" className="shrink-0 flex items-center">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/logos/logo-societe.png"
            alt="Société.com"
        ...
        {/* Barre de recherche — clic redirige vers societe.com */}
        <a
        ...
        <a
          ...
          className="shrink-0 w-11 h-11 rounded-full border border-[#BABFD6] flex items-center justify-center hover:bg-[#F2F9FD] transition-colors"
        >
          <span
